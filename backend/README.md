...
## Project Structure
    ...
    ├── testunverified_dev_25853  # Django project configurations
...
1. Clone this repo and `cd testunverified_dev_25853`
...
2. Clone this repo and `cd testunverified_dev_25853`
